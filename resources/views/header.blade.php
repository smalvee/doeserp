        ...
        <ul class="navbar-nav align-items-center right-nav-link">
                    ...
                    <ul class="list-group list-group-flush">
                            ...
                            <a href="javaScript:void();">
                                <div class="media">
                                    <div class="avatar"><img class="align-self-start mr-3"
                                            src="erp/images/avatars/avatar-1.png" alt="user avatar"></div>
                        ...
                        <li class="list-group-item">
                            <a href="javaScript:void();">
                                <div class="media">
                                    <div class="avatar"><img class="align-self-start mr-3"
                                            src="erp/images/avatars/avatar-2.png" alt="user avatar"></div>
                                    <div class="media-body">
                        ...
                        <li class="list-group-item">
                            <a href="javaScript:void();">
                                <div class="media">
                                    <div class="avatar"><img class="align-self-start mr-3"
                                            src="erp/images/avatars/avatar-3.png" alt="user avatar"></div>
                                    <div class="media-body">
                        ...
                        <li class="list-group-item">
                            <a href="javaScript:void();">
                                <div class="media">
                                    <div class="avatar"><img class="align-self-start mr-3"
                                            src="erp/images/avatars/avatar-4.png" alt="user avatar"></div>
                                    <div class="media-body">
            ...
            <li class="nav-item">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
                    <span class="user-profile"><img src="erp/images/avatars/avatar-17.png"
                ...
                <ul class="dropdown-menu dropdown-menu-right animated fadeIn">
                    <li class="dropdown-item user-details">
                        <a href="javaScript:void();">
                            <div class="media">
                                <div class="avatar"><img class="align-self-start mr-3"
                                        src="erp/images/avatars/avatar-17.png" alt="user avatar"></div>
                                <div class="media-body">
