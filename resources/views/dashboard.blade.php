...
<head>
    ...
    <!-- notifications css -->
    <link rel="stylesheet" href="erp/plugins/notifications/css/lobibox.min.css" />
    <!-- Vector CSS -->
    <link href="erp/plugins/vectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
    <!-- simplebar CSS-->
...
<body onload="info_noti()">
                        ...
                        <div class="card gradient-scooter">
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="align-self-center w-icon"><i class="icon-basket-loaded text-white"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>Iphone 5</td>
                                            <td><img src="erp/images/products/01.png" class="product-img"
                                                    alt="product img"></td>
                                            <td>#9405822</td>
                                        ...
                                        <tr>
                                            <td>Earphone GL</td>
                                            <td><img src="erp/images/products/02.png" class="product-img"
                                                    alt="product img"></td>
                                            <td>#9405820</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="erp/images/products/03.png" class="product-img"
                                                    alt="product img"></td>
                                            <td>#9405830</td>
                                        ...
                                        <tr>
                                            <td>Clasic Shoes</td>
                                            <td><img src="erp/images/products/04.png" class="product-img"
                                                    alt="product img"></td>
                                            <td>#9405825</td>
                                            <td><span class="badge gradient-quepal text-white shadow">Paid</span></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Hand Watch</td>
                                            <td><img src="erp/images/products/05.png" class="product-img"
                                                    alt="product img"></td>
                                            <td>#9405840</td>
                                            <td><span class="badge gradient-bloody text-white shadow">Failed</span>
                                            </td>
    ...
    <script src="erp/plugins/vectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="erp/plugins/vectormap/jquery-jvectormap-world-mill-en.js"></script>
    <!-- Sparkline JS -->
    <script src="erp/plugins/sparkline-charts/jquery.sparkline.min.js"></script>
    <!-- Chart js -->
    <script src="erp/plugins/Chart.js/Chart.min.js"></script>
    <!--notification js -->
    <script src="erp/plugins/notifications/js/lobibox.min.js"></script>
    <script src="erp/plugins/notifications/js/notifications.min.js"></script>
    <!-- Index js -->
    <script src="erp/js/index.js"></script>
